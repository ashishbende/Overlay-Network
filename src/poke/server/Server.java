...
public class Server {
	...
	private void startManagers() {
		...
		/*****
		 * This will start the monitor thread and check whether there
		 * is leader or not. If not then it will start the Election. This thread
		 * is used to send append call to all the followers. If they don't receive
		 * messages within a certain period then they will initiate election.
		 */
